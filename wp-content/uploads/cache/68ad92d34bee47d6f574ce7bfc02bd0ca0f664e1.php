<?php $__env->startSection('content'); ?>
	...
	<section class="feature-section col-11 sm-col-8 clearfix mx-auto pb6">
		...
		<div class="feature-grid clearfix mxn2">
			<div class="feature col col-12 sm-col-6 px2 mt3">
				<div class="card">
					<h3 class="feature__title mb3">
	...
	<section class="goal-section pt6 pb6">
		<div class=" col-11 sm-col-8 clearfix mx-auto">
			<div class="col-7">
				...
				<p class="mb4">Välj bland flera populära mål få förslag på åtgärder och följ dem till framgång.</p>
			</div>
